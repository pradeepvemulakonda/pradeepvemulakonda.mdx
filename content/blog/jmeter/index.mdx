    ...
    <build>
        <plugins>
            <plugin>
                ...
                <version>1.1.0</version>
                <configuration>
                    <jmeterhome>/target/jmeter</jmeterhome>
                    <input>/src/test/jmeter/main.jmx</input>
                    <heap>756m</heap>
                    <jmeterVariables>
                        ...
                        <property>
                            ...
                            <value>/in/users.csv</value>
                        </property>
                        <property>
                            <name>gsPFilePath</name>
                            <value>/in/patients.csv</value>
                        </property>
                        <property>
                            <name>gsListTemplateFilePath</name>
                            <value>/in/payloads/List.json</value>
                        </property>
                        <property>
            ...
            <plugin>
                ...
                <executions>
                    <execution>
                        ...
                        <configuration>
                            <executable>
                             /lib/internal/create-and-copy-users.sh
                            </executable>
                        </configuration>
                    </execution>
                </executions>
