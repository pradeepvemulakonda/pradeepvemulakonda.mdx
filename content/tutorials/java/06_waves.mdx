...
In layman terms: Only a specific set of [waves](https://en.wikibooks.org/wiki/High_School_Chemistry/Schrodinger%27s_Wave_Functions) can exist in nature (becuase we cannot have infinit potential). 
